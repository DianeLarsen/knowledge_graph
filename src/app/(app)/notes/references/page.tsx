...
import NewReferenceForm from "@/components/references/NewReferenceForm";
  ...
  return (
    <main className="mx-auto max-w-5xl px-6 py-8">
      <div className="mb-6 flex items-start justify-between gap-4">
        ...
        <Link
          href="/notes"
          className="shrink-0 rounded-xl border border-gray-300 px-4 py-2 text-sm font-semibold text-gray-700 hover:bg-gray-100 dark:border-gray-700 dark:text-gray-300 dark:hover:bg-gray-800"
        >
          Back to Notes
        </Link>
      </div>
